        const MODULE_TEMPLATES = [
            ...
            <section style="padding: {{sectionSpacing}}; background: {{backgroundColor}};" class="kerberos-module-{{templateId}}">
                <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
                    ...
                    <div style="text-align: center; margin-top: {{buttonSpacing}};">
                        <a href="{{buttonUrl}}" target="{{buttonTarget}}" style="font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{buttonBackground}}; color: {{buttonTextColor}}; padding: {{buttonPadding}}; border-radius: {{buttonRadius}}; text-decoration: none; display: inline-block; transition: all 0.3s ease;">{{buttonText}}</a>
                    </div>
                </div>
            </section>`,
            "properties": {
                ...
                "buttonUrl": "/unternehmen/kontakt",
                "buttonBackground": "#063AA8",
            ...
            <section style="padding: {{sectionSpacing}}; background: {{backgroundColor}}; position: relative; overflow: hidden;" class="kerberos-warning-module kerberos-module-{{templateId}}">
                ...
                <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem; position: relative; z-index: 2;">
                    <div style="text-align: center; margin-bottom: {{contentGap}};">
                        ...
                        <div style="margin: {{buttonSpacing}}; text-align: center;">
                            <a class="kerberos-btn kerberos-btn-{{templateId}}" href="{{buttonUrl}}" style="display: inline-block; font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{buttonColor}}; color: {{buttonTextColor}}; padding: {{buttonPaddingValue}}; border-radius: {{buttonRadiusValue}}; text-decoration: none; border: none; cursor: pointer; transition: all 0.3s ease; box-shadow: {{buttonShadowValue}};">{{buttonText}}</a>
                        </div>
                    </div>
                ...
                properties: {
                    ...
                    // === FACTS STYLING ===
                    lineColor: "#8A2BE2",
                    factNumberSizeType: "heading-2",      // Default-Wert hinzugefügt
                    factNumberColor: "#009CE6",
                    factTextSizeType: "normal-text",      // Default-Wert hinzugefügt
        ...
        {
            "id": "kerberos-hero-advanced-richtext",
            "name": "Hero Advanced mit Rich-Text",
            "category": "Hero & Headers", 
            "description": "Hero-Sektion mit Rich-Text, Höhen-Kontrolle und automatischen Dropdowns",
            "html": `{{processedContent}}`,
            "properties": {
                // === CONTENT ===
                "titleContent": "Professionelle Compliance-Lösungen",
                "titleColor": "#FFFFFF",
                "subtitleContent": "Wir unterstützen Sie bei der Umsetzung aller Compliance-Anforderungen. Von der Erstberatung bis zur vollständigen Implementierung stehen wir Ihnen zur Seite.",
                "subtitleColor": "#FFFFFF",
                "textAlignment": "left",
                ...
                "contentGap": "4rem",
                "sectionSpacing": "6rem 0",
                "verticalSpacing": "medium",      // ✅ NEUE DROPDOWN-PROPERTY
                
                // === IMAGE SYSTEM (UNIVERSELL-KOMPATIBEL) ===
                ...
                "imageRadiusType": "medium",    // Wird vom universellen System verarbeitet
                "imageShadowType": "light",     // Wird vom universellen System verarbeitet
                // === UNIVERSELLE BILDBEARBEITUNG ===
                "imageHeight": "auto",
                "imageObjectFit": "cover", 
                "imageObjectPosition": "center",
                "imageCustomCSS": "",
                
                // === BUTTON SYSTEM (UNIVERSELL-KOMPATIBEL) ===
                ...
                "backgroundImage": "https://images.squarespace-cdn.com/content/651eacf7cae17a228645a660/5b4c31ed-6bec-4b74-9c96-64cd20176893/Fu%C3%9Fballspieler%2Bauf%2BLaptop-Grafik.jpg?content-type=image%2Fjpeg",
...

        {
            ...
            "html": `<section style="{{responsiveBackground}}; color: white; padding: {{sectionSpacing}}; text-align: center; margin-bottom: 0; position: relative;" class="kerberos-module-{{moduleId}}">
                ...
                <div style="position: relative; z-index: 3; max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
                    ...
                    <a class="kerberos-btn kerberos-btn-{{moduleId}}" href="{{buttonLink}}" style="font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{buttonBackground}}; color: {{buttonColor}}; padding: {{buttonPadding}}; border-radius: {{buttonRadius}}; text-decoration: none; display: inline-block; border: 2px solid rgba(255,255,255,0.3); transition: all 0.3s ease;">{{buttonText}}</a>
                </div>
            </section>`,
            "properties": {
                // === CONTENT ===
                ...
                // === BUTTON (MIT RICHTIGEN DROPDOWNS) ===
                ...
                // === BACKGROUND (MIT GRADIENT-DROPDOWN) ===
                "backgroundImage": "",
                ...
                <section style="padding: {{sectionSpacing}}; background: {{backgroundColor}}; position: relative;" class="kerberos-module-{{templateId}}">
                    <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
                        ...
                        <div style="text-align: center; margin: {{ctaSpacing}} 0; display: {{showCTA}};">
                            <a href="{{ctaLink}}" style="background: {{ctaBackgroundColor}}; color: {{ctaTextColor}}; text-decoration: none; padding: {{buttonPaddingType}}; border-radius: {{buttonRadiusType}}; font-weight: 700; font-size: 1.1rem; transition: all 0.3s ease; font-family: var(--body-font-font-family); box-shadow: {{buttonShadowType}}; display: inline-block;">{{ctaText}}</a>
                        </div>
                        ...
                        <div style="text-align: center; margin-top: {{ctaSpacing}}; display: {{showBottomCTA}};">
                            <a href="{{bottomCtaLink}}" style="background: {{ctaBackgroundColor}}; color: {{ctaTextColor}}; text-decoration: none; padding: {{buttonPaddingType}}; border-radius: {{buttonRadiusType}}; font-weight: 700; font-size: 1.1rem; transition: all 0.3s ease; font-family: var(--body-font-font-family); box-shadow: {{buttonShadowType}};">{{bottomCtaText}}</a>
                        </div>
                    </div>
                </section>`,
                "properties": {
                    ...
                    "hoverShadowType": "0 12px 30px rgba(6,58,168,0.2)",
                    "buttonPaddingType": "1rem 2.5rem",
                    "buttonRadiusType": "8px",
                    "buttonShadowType": "0 4px 15px rgba(6,58,168,0.25)",

                    // === SICHTBARKEITS-EINSTELLUNGEN ===
                    "showConnectionLine": "block",
                    "showBottomCTA": "none",
...

            {
                ...
                "html": `<section style="background: {{backgroundColor}}; padding: {{sectionSpacing}}; text-align: center; margin-bottom: 0; position: relative;" class="kerberos-module-{{moduleId}}">
                    ...
                    <div style="position: relative; z-index: 3; max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
                        ...
                        <a class="kerberos-btn kerberos-btn-{{moduleId}}" href="{{buttonLink}}" style="font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{buttonBackground}}; color: {{buttonColor}}; padding: {{buttonPadding}}; border-radius: {{buttonRadius}}; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; box-shadow: {{buttonShadow}}; transition: all 0.3s ease;">
                            {{buttonText}}
...

            {
                    ...
                    <div style="max-width: 1400px; margin: 0 auto; padding: 0 2rem;">
                        ...
                        <div style="background: {{cardBackground}}; border-radius: {{cardRadiusType}}; padding: {{cardPaddingType}}; box-shadow: {{cardShadowType}}; border: 1px solid {{cardBorder}}; position: relative; overflow: hidden;">
                            ...
                            <div style="text-align: center; margin-top: {{ctaSpacing}}; padding-top: {{ctaSpacing}}; border-top: 1px solid {{cardBorder}};">
                                <a href="{{buttonLink}}" style="font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{primaryColor}}; color: white; padding: {{buttonPaddingType}}; border-radius: {{buttonRadiusType}}; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.3s ease; box-shadow: {{buttonShadowType}};">{{buttonText}}<span style="font-family: 'Font Awesome 5 Pro';">{{buttonIcon}}</span></a>
                            </div>
                        </div>
                    </div>
                </section>`,
                "properties": {
                    ...
                    // === BUTTON ===
                    "buttonText": "Live-Demo anfordern",
                    "buttonLink": "#demo",
                    "buttonIcon": "&#xf04b;",
                    "buttonPaddingType": "medium",
                    "buttonRadiusType": "medium",
                ...
                <section style="padding: {{sectionSpacing}}; background: {{backgroundColor}};" class="kerberos-module-{{templateId}}">
                    <div style="max-width: 1400px; margin: 0 auto; padding: 0 2rem;">
                        ...
                        <div style="margin-top: {{ctaSpacing}}; text-align: center;">
                            <a class="kerberos-btn kerberos-btn-{{templateId}}" href="{{docsLink}}" style="font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{primaryColor}}; color: {{buttonTextColor}}; padding: {{buttonPaddingType}}; border-radius: {{buttonRadiusType}}; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.3s ease;">{{docsButtonText}}<span style="font-family: 'Font Awesome 5 Pro';">{{docsButtonIcon}}</span></a>
                        </div>
                    </div>
                </section>`,
                "properties": {
                    ...
                    "docsButtonText": "Vollständige API-Dokumentation",
                    "docsButtonIcon": "&#xf35d;",
                        ...
                        <div style="display: grid; grid-template-columns: 1fr; gap: {{contentGap}}; align-items: center;">
                            <div style="display: grid; grid-template-columns: 1fr 400px; gap: {{mainContentGap}}; align-items: center; margin-bottom: {{sectionSpacing}};">
                                <div>
                                    ...
                                    <a href="{{buttonLink}}" style="display: inline-flex; align-items: center; gap: 0.5rem; background: {{buttonBgColor}}; color: {{buttonTextColor}}; padding: {{buttonPaddingType}}; border-radius: {{buttonRadiusType}}; text-decoration: none; font-weight: 500; transition: all 0.3s ease;">{{buttonText}}</a>
                                </div>
                                {{rightSideContent}}
                            </div>
...

        {
                    ...
                    <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: {{contentGap}}; align-items: center; min-height: {{minHeightType}};">
                            ...
                            <div style="order: {{textOrder}}; padding: {{contentPaddingType}};">
                                ...
                                <div style="margin-top: {{buttonSpacing}}; display: {{showButton}};">
                                    <a href="{{buttonLink}}" style="font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{buttonBgColor}}; color: {{buttonTextColor}}; padding: {{buttonPaddingType}}; border-radius: {{buttonRadiusType}}; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; border: {{buttonBorderType}}; box-shadow: {{buttonShadowType}};">
                                        {{buttonText}}
                                        <span style="font-family: 'Font Awesome 5 Pro'; display: {{showButtonIcon}};">{{buttonIcon}}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
...

            {
                ...
                "properties": {
                    ...
                    "secondaryButtonIcon": "&#xf35d;",
                    "showSecondaryButton": "inline-flex",
...

            {
                ...
                "properties": {
                    ...
                    // === PRIMARY BUTTON (EINHEITLICHE KONVENTION) ===
                    "buttonText": "Jetzt entdecken", 
                    "buttonLink": "#",
                    "buttonIcon": "&#xf061;",
                    "buttonStyleType": "secondary", 
                    "buttonPaddingType": "large",
                    "buttonRadiusType": "medium", 
                    "buttonShadowType": "strong",
                    "buttonBackground": "#FFFFFF", 
                    "buttonColor": "#063AA8",

                    // === SECONDARY BUTTON (EINHEITLICHE KONVENTION) ===
                    ...
                    "backgroundPatternType": "repeating-diagonal",  // Wird durch processUniversalTypeMappings gemappt
                    "backgroundOpacityType": "light",               // Wird durch processUniversalTypeMappings gemappt  
                    "sectionSpacing": "4rem 0",
                    ...
                    <div style="max-width: {{maxWidthType}}; margin: 0 auto; padding: 0 2rem;">
                        ...
                        <div style="margin-bottom: {{buttonSpacing}};">
                            <div style="display: flex; flex-wrap: wrap; gap: {{buttonGapType}}; justify-content: {{buttonJustifyType}};">
                                <a href="{{buttonLink}}" style="font-family: var(--button-font-family); font-weight: var(--button-font-weight); background: {{primaryButtonBackground}}; color: {{primaryButtonColor}}; padding: {{primaryButtonPadding}}; border-radius: {{primaryButtonRadius}}; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.3s ease; box-shadow: {{primaryButtonShadow}};">
                                    {{buttonText}}
                                    <span style="font-family: 'Font Awesome 5 Pro';">{{buttonIcon}}</span>
                                </a>
